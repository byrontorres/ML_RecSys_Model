...
df_users_items = pd.read_csv('Data_ETL/data_users_items_clean.csv')
...
# Cargar los datos
df_reviews = pd.read_csv('Data_ETL/user_reviews_clean.csv')
df_games = pd.read_csv('Data_ETL/data_games_clean.csv')
...
df_users_items = pd.read_csv('Data_ETL/data_users_items_clean.csv')
df_user_reviews = pd.read_csv('Data_ETL/user_reviews_clean.csv')
...
def cargar_recomendaciones():
    return pd.read_csv('SistemReco/feel.csv')
